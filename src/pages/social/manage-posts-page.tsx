								...
								<div key={post.id} className="flex items-center gap-4 px-4 py-3 border-b border-[var(--border)] last:border-0 hover:bg-[var(--muted)]/20 transition-colors group">
									...
									<div className="flex-1 min-w-0">
										...
										<div className="flex items-center gap-1 mt-1 flex-wrap">
											...
											{post.approval_status === "pending" && post.scheduled_time && new Date(post.scheduled_time) < new Date() && (
												<span className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium bg-red-50 text-red-600">
													⚠️ Overdue
												</span>
											)}
