						...
						comments.map((c) => {
							...
							return (
								<button
									...
									className={`w-full flex items-start gap-3 px-3 py-3 text-left border-b border-[var(--border)] hover:bg-[var(--muted)]/30 transition-colors ${isActive ? "bg-[var(--muted)]/50" : ""}`}
								>
