	...
	return (
		<div
			className={cn(
				...
				isActive
					? "bg-[color-mix(in_srgb,var(--sq-primary)_10%,transparent)]"
					: "hover:bg-[var(--accent)]",
			)}
		...
		>
			...
			<div className="flex-1 min-w-0">
				<p
					className={cn(
						...
						isActive ? "text-[var(--sq-primary)]" : "text-[var(--foreground)]",
					)}
				>
					{ws.name}
				</p>
			...
			<div className="flex items-center gap-1 shrink-0">
				...
				<button
					...
					className="rounded-md p-1 text-[var(--muted-foreground)] opacity-0 group-hover:opacity-100 hover:bg-[var(--accent)] transition-colors"
